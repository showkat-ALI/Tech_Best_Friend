        ...
        <div className="my-10 container px-4 lg:px-4 xl:px-0 md:px-4 font-nunito">
          <div>
            ...
            <div className="text-gray-400">
              <p className="mt-2">
                ...
                which are deemed necessary to protect the organaization, its
                team members, as well as all operations and assets of the
                organaization.
              </p>
              <p className="my-4">
                The framework is designed to access all the layers of the
                organaization, understand the goals of each project, and monitor
                all operating systems to identify and analyze any possible risk
                management and mitigation strategies.
              </p>
              <p>
                We tain newbies to become experts in the Federal information
                Security nad Modernization Act (FISMA) Risk Management Framework
                (RMF) process.
              </p>
              <p className="my-4">
          ...
          <div>
            ...
            <p className="my-4 text-gray-400">
              ...
              privileged We deliver programs around key tech sectors and provide
              African technology startups with the necessary knowledge,tools,
              and resources they require to go advance in their career of
              propelling their business
            </p>
          </div>
          <div>
            ...
            <p className="my-4 text-gray-400">
              ...
              affluence within our communities by placing people into fulfiling
