     ...
     <form onSubmit={handleSubmit(submitThirdStep)}>
      <div className='Curriculum p-3 mt-5'>
          ...
          <div className=''>
             ...
             { isSuccess && data.data.modules.map(({duration,id,name,assignments,quizzes,videos,slides}:{duration:number;id:string,name:string,index:string,assignments:string[];quizzes:string[],videos:string[],slides:string[]},index:string) => (
