       ...
       <form>
        ...
        <div className='p-5'style={{boxShadow: "0px 1px 15px rgba(0, 0, 0, 0.15)"}}>
             ...
             <div>
                 ...
                 <input onChange={fileGet} className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>
             </div>
             <div className='mt-5'>
