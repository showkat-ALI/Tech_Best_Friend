...
const AddModuleModal = ({show, setShowModal }: {show:boolean;setShowModal:Function}) => {
    ...
    const [createModuleCourse, { error, data, isLoading, isSuccess, isError }] = useCreateModuleCourseMutation();
      ...
      >
        ...
        <Modal.Body>
          <div className="px-6 py-6 lg:px-8">
            <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add Module</h3>
