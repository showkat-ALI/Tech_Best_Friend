              ...
              <div className='from_middel lg:flex md:flex gap-7 sm:block'>
                  <div className='from_lft lg:w-3/6 sm:w-full'>
                     ...
                     <div className='form_control h-[7rem]'>
                         ...
                         <input maxLength={2} type='text' className='mt-3' placeholder='Enter course time' style={{background:' #FFFFFF',boxShadow: '0px 1px 15px rgb(0 0 0 / 15%)',borderRadius: '8px',width: '100%',border: 'none',padding:' 11px 17px'}} {...register("durationInMinutes", { required: true })}/>
                          <div  className=''>
                  ...
                  <div className='form_right lg:w-3/6 sm:w-full'>
                      <div className='form_control  h-[7rem]'>
                          ...
                          <select {...register("level", { required: true })} className='mt-3 text-[#8A92A6]' style={{boxShadow: '0px 1px 15px rgb(0 0 0 / 15%)',borderRadius: '8px',width: '100%',border: 'none',padding:' 11px 17px'}}>
                           <option value={""}>{"All level"}</option>
                             {["Beginner", "Intermediate","Advance"].map((item, id) => (
                               <option value={item} key={id}>
                                 {item}
                               </option>
                             ))}
                      ...
                      <div className='form_control  h-[7rem]'>
                          ...
                          <input type='number' {...register("numberOfLectures", { required: true })} className='mt-3' placeholder='Enter total lecture' style={{background:' #FFFFFF',boxShadow: '0px 1px 15px rgb(0 0 0 / 15%)',borderRadius: '8px',width: '100%',border: 'none',padding:' 11px 17px'}} maxLength={3}/>
                           <div  className=''>
