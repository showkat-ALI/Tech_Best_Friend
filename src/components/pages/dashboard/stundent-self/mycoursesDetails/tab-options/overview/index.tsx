    ...
    <div>
      ...
      <div className="py-9 border-b-2 border-gray-400 grid grid-cols-4 gap-x-6">
        ...
        <div className="text-small-text-color text-sm flex flex-col gap-y-1">
          ...
          <p>Videos: {enrollmentData.course.durationInMinutes / 60} hours total</p>
        </div>
      </div>
      <div className="py-9 border-b-2 border-gray-400 grid grid-cols-4 gap-x-6">
      ...
      <div className="py-9 border-b-2 border-gray-400 grid grid-cols-4 gap-x-6">
        ...
        <div className=" text-sm flex flex-col gap-y-3">
          <div dangerouslySetInnerHTML={{__html:  enrollmentData.course.description}} />
        </div>
      </div>
      <div className="pt-9 border-b-2 border-gray-400 grid grid-cols-4 gap-x-6">
        ...
        <div className=" text-sm flex flex-col gap-y-3">
         { 
         enrollmentData.course.instructors && enrollmentData.course.instructors.map(({avatar,firstName}:{avatar:string,firstName:string}) => (
          <div className="flex gap-3 items-center mb-3">
               <Image src={avatar}   objectFit="cover" alt='courseImage' className="rounded-full" width={48} height={48}/>
