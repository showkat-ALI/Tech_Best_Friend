...
const CourseCard = ({item}:{item:any}) => {
  return (
   <Link href={"/dashboard/student-self/my-course/[id]"} as={`/dashboard/student-self/my-course/${item.id}`}>
            ...
            <div className='bg-[#FFFFFF] p-3'>
                         ...
                         <div>
                           <div className='flex justify-between pt-3 pb-2'>
                               <span className='text-[#8A92A6]'>Days <span className='text-black'>17/15</span></span>
