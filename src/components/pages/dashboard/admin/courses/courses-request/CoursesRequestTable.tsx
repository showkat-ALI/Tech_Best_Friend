                            ...
                            >
                                <table className={`w-full text-[16px] md:text-[18px] text-left`}>
                                    ...
                                    <tbody className="text-[#232D42]">
                                        {data.data.courses.map(({ _id, title, instructors, createdAt, isActive, isPending }: { _id: string, title: string, instructors: { id: string, firstName: string, lastName: string }[], createdAt: Date, isActive: boolean, isPending: boolean }) => (
