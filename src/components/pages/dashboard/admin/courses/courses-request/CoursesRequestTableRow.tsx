...
import { useAcceptCourseMutation, useDeleteCourseMutation } from "../../../../../../feature/api/dashboardApi";
...
const CoursesRequestTableRow = (props: Props) => {
    ...
    const { id, instructors, courseTitle, date, isPending, isActive } = props;
    ...
    return (
        <tr className="border-b">
            ...
            <td className="py-4 px-6 text-center">{new Date(date).toLocaleDateString()}</td>
           ...
           `}
            ...
            <td className="py-4 px-6">
                <div className="flex justify-center items-center space-x-6">
                    <button onClick={() => setShowAcceptCourseModal(true)} className="bg-[#3A57E8] rounded text-white px-3 lg:px-5 py-1 lg:py-2 ">
                        Accept
                    </button>
                    <button onClick={() => setShowRejectCourseModal(true)} className="bg-[#C03221] rounded text-white px-3 lg:px-5 py-1 lg:py-2 ">
                        Reject
                    </button>
                    <button onClick={() => setShowDeleteCourseModal(true)} className="items-center text-[#C03221] text-2xl">
                        <AiOutlineDelete />
                    </button>
                </div>
            </td>
